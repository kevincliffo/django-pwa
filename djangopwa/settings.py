...
PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, r'app\static\app\js', 'serviceworker.js')
print('PWA_SERVICE_WORKER_PATH : ' + PWA_SERVICE_WORKER_PATH)
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'l)9)pb8&0+v3jlx4=!*m9s%&wn)qt@)^kgpvz3x#!!t+w^ub@w'
...
PWA_APP_DESCRIPTION = "Django PWA"
...
PWA_APP_ICONS = [
	{
		'src': '../static/app/images/icon-160x160.png',
		'sizes': '70x70'
	}
]
PWA_APP_ICONS_APPLE = [
...
PWA_APP_SPLASH_SCREEN = [
	{
		'src': '../static/app/images/icon.png',
